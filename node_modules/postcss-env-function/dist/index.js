...
var getReplacedValue = ((originalValue, variables) => {
  ...
  const ast = postcssValuesParser.parse(originalValue); // walk all of the css env() functions
...
function importEnvironmentVariablesFromObject(object) {
  ...
  for (const key in environmentVariables) {
    environmentVariables[key] = postcssValuesParser.parse(environmentVariables[key]).nodes;
  }
